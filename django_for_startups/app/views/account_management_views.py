...
from utils.error_utils import get_validation_error_response, get_business_requirement_error_response
...
class User(APIView):
    ...
    def get(self, request):
        user_profile_dict = account_management_service.get_user_profile_from_user_model(request.user)
