...
class LoginTestCase(TestCase):
    def setUp(self):
        ...
        self.view1 = rest_framework_jwt.views.obtain_jwt_token
    ...
    def test_user_can_log_into_site_with_username(self):
        ...
        request2 = self.factory.get(
            "/account_management/user/", HTTP_AUTHORIZATION=auth_header_value
        )
    ...
    def test_user_can_log_into_site_with_uppercase_username(self):
        post_request_data = {
            "nfkc_username": self.username.upper(),
            "password": self.password,
        }
    ...
    def test_user_can_log_into_site_with_email_adress(self):
        post_request_data = {
            "nfkc_username": self.email_address,
            "password": self.password,
        }
    ...
    def test_user_can_log_into_site_with_uppercase_email_adress(self):
        post_request_data = {
            "nfkc_username": self.email_address.upper(),
            "password": self.password,
        }
